    ...
    <section className="about" id="about">
      <div className="about__inner">
        ...
        <p className="about__text">
          ...
          systems using modern MLOps practices. In my free time I contribute
          to open-source ASR development for the Polish language, keeping up
          with the latest AI research and techniques.
        </p>
